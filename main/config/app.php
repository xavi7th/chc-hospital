...
return [
  ...
  'name' => env('APP_NAME', 'Capitol Hill Hospital/Clinic'),
  'email' => env('APP_EMAIL', null),
  'email2' => env('APP_EMAIL2', null),
  'email3' => env('APP_EMAIL3', null),
  'email4' => env('APP_EMAIL4', null),
  'phone1' => env('APP_PHONE1', null),
