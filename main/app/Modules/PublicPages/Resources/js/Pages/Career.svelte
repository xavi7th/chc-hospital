    ...
    <div class="container">
      <div
        ...
        <div class="col-md-10 col-lg-6 col-xl-5">
          <p class="mb-3">
            At Capitol Hill Clinic / Hospital, we recognize that our staff are
            central to our success. We are therefore committed to recruiting and
            retaining high caliber staff with passion and drive, who we know
            will exceed our clients' expectations. While communications
            experience is an asset in our sector, we also invite speculative
            applications from talented, driven professionals, whom we will train
            and mentor to ensure that they achieve their full potential. Regular
            performance reviews and bonuses recognize individuals for going
            above and beyond the hospital's expectations. This, together with
            our competitive salaries, ensures that any highly motivated
            individual will excel in our friendly, fast-paced working
            environment. If you would like to become a part of our devoted and
            caring team while receiving a comprehensive wage and benefits
            package that meets the needs of our employees and their families on
            a personal and individual basis, submit your CV below.
          </p>
          <InertiaLink
            class="button button-lg button-primary button-winona btn-xs"
            style="padding: 10px 20px; font-size: 1em ; margin-top: 15px;"
          ...
          <form
            ...
            <div class="form-button">
              <button class="button button-primary button-winona" type="submit">
                <div class="content-original">Join Our Family</div>
