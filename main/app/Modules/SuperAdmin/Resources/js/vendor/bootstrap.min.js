		...
		var Alert =
			...
			function() {
				...
				_proto._removeElement = function _removeElement(element) {
					...
					if (!Util.supportsTransitionEnd() || !$$$1(element)
		...
		var Button =
			...
			function() {
				...
				_proto.toggle = function toggle() {
					...
					if (rootElement) {
						var input = $$$1(this._element)
							.find(Selector.INPUT)[0];

						if (input) {
							if (input.type === 'radio') {
								if (input.checked && $$$1(this._element)
									.hasClass(ClassName.ACTIVE)) {
									triggerChangeEvent = false;
								} else {
									var activeElement = $$$1(rootElement)
		...
		var Carousel =
			...
			function() {
				...
				_proto.nextWhenVisible = function nextWhenVisible() {
					...
					if (!document.hidden && $$$1(this._element)
						.is(':visible') && $$$1(this._element)
				...
				_proto.pause = function pause(event) {
					...
					if ($$$1(this._element)
						.find(Selector.NEXT_PREV)[0] && Util.supportsTransitionEnd()) {
				...
				_proto.to = function to(index) {
					...
					this._activeElement = $$$1(this._element)
						.find(Selector.ACTIVE_ITEM)[0];
				...
				_proto._addEventListeners = function _addEventListeners() {
					...
					if (this._config.keyboard) {
						$$$1(this._element)
							.on(Event.KEYDOWN, function(event) {
				...
				_proto._triggerSlideEvent = function _triggerSlideEvent(relatedTarget, eventDirectionName) {
					...
					var fromIndex = this._getItemIndex($$$1(this._element)
						.find(Selector.ACTIVE_ITEM)[0]);
				...
				_proto._slide = function _slide(direction, element) {
					...
					var activeElement = $$$1(this._element)
						.find(Selector.ACTIVE_ITEM)[0];
					...
					if (Util.supportsTransitionEnd() && $$$1(this._element)
						.hasClass(ClassName.SLIDE)) {
						$$$1(nextElement)
				...
				Carousel._jQueryInterface = function _jQueryInterface(config) {
					return this.each(function() {
						...
						var _config = _extends({}, Default, $$$1(this)
							.data());
				...
				Carousel._dataApiClickHandler = function _dataApiClickHandler(event) {
					...
					if (!target || !$$$1(target)
						.hasClass(ClassName.CAROUSEL)) {
						return;
					}

					var config = _extends({}, $$$1(target)
						.data(), $$$1(this)
						.data());
		...
		var Collapse =
			...
			function() {
				...
				_proto.show = function show() {
					...
					if (this._isTransitioning || $$$1(this._element)
						.hasClass(ClassName.SHOW)) {
						return;
					}
					...
					if (actives) {
						Collapse._jQueryInterface.call($$$1(actives)
	...
	var Dropdown = function($$$1) {
		...
		var Dropdown =
			...
			function() {
				...
				// Public
				_proto.toggle = function toggle() {
					if (this._element.disabled || $$$1(this._element)
						.hasClass(ClassName.DISABLED)) {
						return;
					}

					var parent = Dropdown._getParentFromElement(this._element);

					var isActive = $$$1(this._menu)
						.hasClass(ClassName.SHOW);
					...
					if (!this._inNavbar) {
						...
						if ($$$1(parent)
							.hasClass(ClassName.DROPUP)) {
							if ($$$1(this._menu)
								.hasClass(ClassName.MENULEFT) || $$$1(this._menu)
						...
						if (this._config.boundary !== 'scrollParent') {
							$$$1(parent)
								.addClass(ClassName.POSITION_STATIC);
						}
				...
				Dropdown._dataApiKeydownHandler = function _dataApiKeydownHandler(event) {
					...
					if (/input|textarea/i.test(event.target.tagName) ? event.which === SPACE_KEYCODE || event.which !==
						ESCAPE_KEYCODE && (event.which !== ARROW_DOWN_KEYCODE && event.which !== ARROW_UP_KEYCODE || $$$1(
							...
							.length) : !REGEXP_KEYDOWN.test(event.which)) {
						return;
					}
	...
	var Modal = function($$$1) {
		...
		var Modal =
			...
			function() {
				function Modal(element, config) {
					this._config = this._getConfig(config);
					this._element = element;
					this._dialog = $$$1(element)
						.find(Selector.DIALOG)[0];
					this._backdrop = null;
					this._isShown = false;
				...
				_proto.show = function show(relatedTarget) {
					...
					$$$1(this._dialog)
						.on(Event.MOUSEDOWN_DISMISS, function() {
							$$$1(_this._element)
				...
				_proto._showBackdrop = function _showBackdrop(callback) {
					...
					var animate = $$$1(this._element)
						.hasClass(ClassName.FADE) ? ClassName.FADE : '';
		...
		$$$1(document)
			.on(Event.CLICK_DATA_API, Selector.DATA_TOGGLE, function(event) {
				...
				var config = $$$1(target)
					.data(DATA_KEY) ? 'toggle' : _extends({}, $$$1(target)
						.data(), $$$1(this)
						.data());
			...
			function() {
				...
				_proto.show = function show() {
					...
					if (this.isWithContent() && this._isEnabled) {
						...
						if (Util.supportsTransitionEnd() && $$$1(this.tip)
							.hasClass(ClassName.FADE)) {
							$$$1(this.tip)
								.one(Util.TRANSITION_END, complete)
				...
				_proto._enter = function _enter(event, context) {
					var dataKey = this.constructor.DATA_KEY;
					context = context || $$$1(event.currentTarget)
						.data(dataKey);
					...
					targets.map(function(element) {
							...
							if (target) {
								...
								if (targetBCR.width || targetBCR.height) {
									...
									return [$$$1(target)[offsetMethod]()
										.top + offsetBase, targetSelector];
								}
							}
			...
			function() {
				...
				_proto.show = function show() {
					...
					if (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && $$$1(this
							._element)
						.hasClass(ClassName.ACTIVE) || $$$1(this._element)
						.hasClass(ClassName.DISABLED)) {
						return;
					}
